...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/nulzo/Github/Cringe-Bot/cmake/dpp_external_project-prefix/src/dpp_external_project'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/nulzo/Github/Cringe-Bot/cmake/dpp_external_project-prefix/src/dpp_external_project'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
